...
import ThumbnailPrompt from '../components/ThumbnailPrompt';
...
const CreateArticle = ({ navigation }) => {
    ...
    const sendArticle = async (thumbUri, category) => {
        var raw = await AsyncStorage.getItem('article');
        var englishData = JSON.parse(raw);
        ...
        for (var i in article) {
            ...
            if (element.type == 'imageSlideshow') {
                ...
                englishData[i].images = {id: postId, index: k};
            }
        }
        ...
        <View style={styles.container}>
            <View style={styles.header}>
                <View style={styles.headerItems}>
                    ...
                    <Text style={styles.headerText}>Romanian preview</Text>
            ...
            <View style={styles.buttonContainer}>
                <TouchableOpacity onPress={() => {
                    ...
                    <Text style={styles.buttonText}>Finish article</Text>
                </TouchableOpacity>
            </View>
